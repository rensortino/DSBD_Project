ffmpeg -i "/home/simoneonesta/Scrivania/videos/5df4fed7ee0c8f3d59676041.mp4" \
-map 0:v:0 -map 0:a\?:0 -map 0:v:0 -map 0:a\?:0 -map 0:v:0 -map 0:a\?:0 -map 0:v:0 -map \
0:a\?:0 -map 0:v:0 -map 0:a\?:0 -map 0:v:0 -map 0:a\?:0 \
...
-f dash "/home/simoneonesta/Scrivania/videos/video.mpd"